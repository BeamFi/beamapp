export const idlFactory = ({ IDL }) => {
  ...
  const Result_3 = IDL.Variant({ ok: EscrowId, err: ErrorCode__1 })
  ...
  const Result_2 = IDL.Variant({ ok: EscrowContract, err: ErrorCode })
  ...
  return IDL.Service({
    ...
    loadEscrow: IDL.Func([JobFlowId], [Result_2], ["query"]),
